...
const KEYWORDS = [
  { text: "Applied AI", gradient: "from-cyan-500 via-blue-600 to-indigo-600" },
  { text: "Prompting", gradient: "from-amber-500 via-orange-600 to-rose-600" },
  { text: "Automation", gradient: "from-fuchsia-500 via-pink-600 to-rose-500" },
  { text: "Systems", gradient: "from-sky-400 via-cyan-500 to-blue-600" },
  { text: "AI Agents", gradient: "from-violet-600 via-purple-600 to-fuchsia-600" },
];
  ...
  return (
    <div className="relative min-h-screen text-slate-800 select-none font-sans overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-32 sm:pt-40 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 text-left z-20">
            <div className="font-black tracking-tight text-5xl sm:text-[4.5rem] leading-[1.1] text-slate-900 drop-shadow-sm">
              <span className="text-[#1e1b4b]">Build And Deploy </span>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute w-[460px] h-[320px] rounded-2xl bg-[#1e1b4b]/90 backdrop-blur-3xl border border-white/10 shadow-[0_30px_70px_rgba(30,27,75,0.4)] overflow-hidden flex"
              >
                <div className="w-[140px] bg-black/20 p-4 border-r border-white/5 flex flex-col gap-4">
                  <div className="flex gap-1.5 mb-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-rose-500" />
                    <div className="w-2.5 h-2.5 rounded-full bg-amber-500" />
                    <div className="w-2.5 h-2.5 rounded-full bg-emerald-500" />
                  </div>
                  <div className="h-6 w-full bg-white/10 rounded-md flex items-center px-2 gap-1.5">
                    <Search size={10} className="text-white/50" />
                    <span className="text-[9px] text-white/50 font-medium">Search</span>
                  </div>
                  <div className="space-y-3 mt-2">
                    <div className="flex items-center gap-2 text-white/70">
                      <BookOpen size={12} /><div className="h-1.5 w-12 bg-white/20 rounded-full" />
                    </div>
                    <div className="flex items-center gap-2 text-white/70">
                      <Star size={12} /><div className="h-1.5 w-16 bg-white/20 rounded-full" />
                    </div>
                    <div className="flex items-center gap-2 text-white/70">
                      <Compass size={12} /><div className="h-1.5 w-10 bg-white/20 rounded-full" />
                    </div>
                  </div>
                  <div className="mt-4">
                    <span className="text-[8px] uppercase tracking-widest text-white/40 font-bold block mb-2">Courses</span>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-blue-500" /><div className="h-1.5 w-12 bg-white/10 rounded-full" /></div>
                      <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-orange-500" /><div className="h-1.5 w-14 bg-white/10 rounded-full" /></div>
                      <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-indigo-500" /><div className="h-1.5 w-10 bg-white/10 rounded-full" /></div>
                    </div>
                  </div>
                </div>
                <div className="flex-1 bg-gradient-to-br from-indigo-900/40 to-purple-900/40 relative overflow-hidden">
                  <div className="absolute top-4 right-4 flex items-center gap-2 bg-black/20 rounded-full px-2 py-1 border border-white/5">
                    <div className="w-4 h-4 rounded-full bg-cyan-400" />
                    <span className="text-[10px] text-white font-medium">Meng To</span>
                    <ChevronDown size={10} className="text-white/50" />
                  </div>
                  <div className="absolute right-8 top-16 w-32 rounded-xl bg-white/5 border border-white/10 p-3 backdrop-blur-md shadow-xl">
                     <div className="flex items-center gap-2 mb-2">
                       <Award size={14} className="text-purple-400" />
                       <span className="text-[10px] text-white font-bold">Certificate</span>
                     </div>
                  ...
                  <svg viewBox="0 0 200 200" className="absolute bottom-0 left-0 w-full h-full opacity-10 pointer-events-none">
                    <path d="M0,100 Q50,50 100,100 T200,100 L200,200 L0,200 Z" fill="currentColor" className="text-indigo-400" />
                  </svg>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 100, damping: 20 }}
                style={{ transformStyle: 'preserve-3d' }}
                className="absolute w-[320px] h-[210px] rounded-[20px] bg-[#2a2a3e]/80 backdrop-blur-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.5)] p-4 flex gap-4"
              >
                <div className="flex-1 flex flex-col justify-center gap-4">
                   <div className="flex gap-3 items-start">
                     <div className="w-5 h-5 rounded-full bg-rose-500 flex items-center justify-center text-[9px] text-white font-bold mt-1 shadow-md shadow-rose-500/30">1</div>
                     <div className="flex-1">
                       <div className="flex justify-between items-center mb-1">
                         <span className="text-[11px] text-white font-bold">Intro to iOS Design</span>
                         <span className="text-[9px] text-rose-400 bg-rose-500/20 px-1 rounded font-bold">6:08</span>
                       </div>
                       <div className="h-0.5 w-full bg-white/10 rounded-full overflow-hidden"><div className="h-full w-3/4 bg-rose-500 rounded-full" /></div>
                       <div className="h-1 w-2/3 bg-white/10 rounded-full mt-2" />
                     </div>
                   </div>
                   <div className="flex gap-3 items-start">
                     <div className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center text-[9px] text-white/50 font-bold mt-1">2</div>
                     <div className="flex-1">
                       <div className="flex justify-between items-center mb-1">
                         <span className="text-[11px] text-white font-bold">Design Guidelines</span>
                         <span className="text-[9px] text-white/40 font-bold">9:02</span>
                       </div>
                       <div className="h-0.5 w-full bg-white/10 rounded-full overflow-hidden"><div className="h-full w-1/4 bg-white/40 rounded-full" /></div>
                       <div className="h-1 w-4/5 bg-white/10 rounded-full mt-2" />
                     </div>
                   </div>
                   <div className="flex gap-3 items-start">
                     <div className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center text-[9px] text-white/50 font-bold mt-1">3</div>
                     <div className="flex-1">
                       <div className="flex justify-between items-center mb-1">
                         <span className="text-[11px] text-white font-bold">Colors and Gradients</span>
                         <span className="text-[9px] text-white/40 font-bold">9:31</span>
                       </div>
                       <div className="h-0.5 w-full bg-white/10 rounded-full overflow-hidden"><div className="h-full w-1/2 bg-white/40 rounded-full" /></div>
                       <div className="h-1 w-3/5 bg-white/10 rounded-full mt-2" />
                     </div>
                   </div>
                </div>
                <div className="w-[120px] rounded-xl bg-blue-500 p-3 relative overflow-hidden flex flex-col items-center justify-center shadow-inner">
                   <div className="absolute top-2 right-2 w-5 h-5 bg-black/20 rounded-full flex items-center justify-center backdrop-blur-md"><Code size={10} className="text-white" /></div>
                   <svg viewBox="0 0 100 100" className="w-full h-20 text-white mb-2">
                     ...
                     <rect x="15" y="65" width="30" height="20" rx="4" fill="#3b82f6" />
                     <rect x="55" y="65" width="30" height="20" rx="4" fill="#3b82f6" />
                     <rect x="30" y="55" width="40" height="8" rx="2" fill="#93c5fd" opacity="0.5" />
                   </svg>
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 100, damping: 20 }}
                style={{ transformStyle: 'preserve-3d' }}
                className="absolute w-[360px] h-[210px] rounded-[20px] bg-[#2a2a3e]/80 backdrop-blur-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.5)] p-4 flex gap-5"
              >
                <div className="w-[140px] rounded-xl bg-violet-600 p-3 relative flex flex-col items-center justify-center overflow-hidden shadow-inner">
                   <div className="absolute top-2 right-2 w-5 h-5 bg-black/20 rounded-full flex items-center justify-center backdrop-blur-md"><Star size={10} className="text-white" /></div>
                   <svg viewBox="0 0 100 100" className="w-full h-24 text-white mb-1">
                     ...
                     <circle cx="30" cy="55" r="12" fill="#a78bfa" />
                     <circle cx="70" cy="55" r="12" fill="#a78bfa" />
                     <rect x="45" y="30" width="10" height="15" fill="#a78bfa" />
                   </svg>
                ...
                <div className="flex-1 flex flex-col justify-center gap-4">
                   <div className="flex gap-3 items-start">
                     <div className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center text-[9px] text-white/50 font-bold mt-1">1</div>
                     <div className="flex-1">
                       <div className="flex justify-between items-center mb-1">
                         <span className="text-[11px] text-white font-bold">Intro to Visual Design</span>
                         <span className="text-[9px] text-white/40 font-bold">10:08</span>
                       </div>
                       <div className="h-0.5 w-full bg-white/10 rounded-full overflow-hidden"><div className="h-full w-1/4 bg-cyan-400 rounded-full" /></div>
                       <div className="h-1 w-2/3 bg-white/10 rounded-full mt-2" />
                     </div>
                   </div>
                   <div className="flex gap-3 items-start">
                     ...
                     <div className="flex-1">
                       <div className="flex justify-between items-center mb-1">
                         <span className="text-[11px] text-white font-bold">Layout and Grids</span>
                         <span className="text-[9px] text-white/40 font-bold">8:02</span>
                       </div>
                       <div className="h-0.5 w-full bg-white/10 rounded-full overflow-hidden"><div className="h-full w-1/3 bg-cyan-400 rounded-full" /></div>
                       <div className="h-1 w-3/4 bg-white/10 rounded-full mt-2" />
                     </div>
                   </div>
                   <div className="flex gap-3 items-start">
                     <div className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center text-[9px] text-white/50 font-bold mt-1">3</div>
                     <div className="flex-1">
                       <div className="flex justify-between items-center mb-1">
                         <span className="text-[11px] text-white font-bold">Colors and Palettes</span>
                         <span className="text-[9px] text-white/40 font-bold">11:12</span>
                       </div>
                       <div className="h-0.5 w-full bg-white/10 rounded-full overflow-hidden"><div className="h-full w-1/2 bg-cyan-400 rounded-full" /></div>
                       <div className="h-1 w-4/5 bg-white/10 rounded-full mt-2" />
                     </div>
                   </div>
                </div>
              ...
              <motion.div
                variants={{
                  initial: { rotateX: 15, rotateY: -20, rotateZ: 5, z: -100, x: -140, y: -120, scale: 0.8 },
                  hover: { rotateX: 0, rotateY: 0, rotateZ: 0, z: -100, x: -300, y: -160, scale: 0.85 }
                }}
                transition={{ type: "spring", stiffness: 90, damping: 20 }}
                style={{ transformStyle: 'preserve-3d' }}
                className="absolute w-[180px] h-[100px] rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 p-4 shadow-2xl border border-white/20"
              >
                <div className="flex justify-between items-start">
                  <div>
                    <h6 className="text-[10px] font-black text-white tracking-wider">SWIFTUI</h6>
                    <span className="text-[8px] text-white/70">Certificate</span>
                  </div>
                  <div className="w-6 h-6 bg-cyan-400 rounded-full flex items-center justify-center shadow-lg"><Terminal size={12} className="text-indigo-900" /></div>
                </div>
              ...
              <motion.div
                variants={{
                  initial: { rotateX: 15, rotateY: -20, rotateZ: 5, z: -200, x: -20, y: -160, scale: 0.8 },
                  hover: { rotateX: 0, rotateY: 0, rotateZ: 0, z: -200, x: -100, y: -280, scale: 0.85 }
                }}
                transition={{ type: "spring", stiffness: 90, damping: 20 }}
                style={{ transformStyle: 'preserve-3d' }}
                className="absolute w-[180px] h-[100px] rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 p-4 shadow-2xl border border-white/20"
              >
                <div className="flex justify-between items-start">
                  <div>
                    <h6 className="text-[10px] font-black text-white tracking-wider">SWIFTUI</h6>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {roadmaps.map((track, i) => {
              ...
              return (
                <div key={i} className="rounded-3xl p-8 bg-white/70 backdrop-blur-xl border border-indigo-100 hover:border-indigo-300 transition-all duration-300 space-y-6 flex flex-col justify-between shadow-sm hover:shadow-md group relative overflow-hidden">

                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className={`px-3 py-1 rounded-full text-[10px] font-mono uppercase tracking-wider border ${track.accent}`}>
                        {track.level}
                      </span>
                      <span className="text-xs font-mono text-slate-500 flex items-center gap-1">
                        <Clock size={12} className="text-indigo-600" /> {track.duration}
                      </span>
                    </div>
                    ...
                    <h3 className="text-xl font-bold text-slate-900 tracking-tight">{track.title}</h3>
                    <p className="text-xs font-medium text-slate-600 leading-relaxed">{track.desc}</p>
                  </div>
                  <a href="#catalog" className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center gap-1.5 transition-colors pt-4 border-t border-indigo-100/80">
      ...
      <div id="catalog" className="relative z-10 py-20 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 pt-4">
            {[
              { icon: Heart, label: "Enjoy coding like\nnever before", gradient: "from-pink-500 to-light-pink-400" },
              { icon: Target, label: "Reach out to new\nclients", gradient: "from-pink-500 to-light-pink-400" },
              { icon: Trophy, label: "Stand out against\nthe competition", gradient: "from-pink-500 to-light-pink-400" },
              { icon: HandCoins, label: "Increase your pay\nrate", gradient: "from-pink-500 to-light-pink-400" },
            ].map((item, i) => {
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-12 sm:gap-24 pt-16">
            <div className="text-center space-y-2">
              <div className="text-7xl font-black bg-clip-text text-transparent bg-gradient-to-br from-indigo-500 to-violet-600">
                4
              </div>
            ...
            <div className="text-center space-y-2">
              ...
              <div className="text-xl font-bold text-slate-800 flex items-center justify-center gap-2">
                Hours of tutorial <MonitorPlay size={20} />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 w-full pt-12 pb-24 px-6 lg:px-12 flex flex-col items-center">
        {/* Banner */}
        <div className="w-full max-w-5xl bg-gradient-to-br from-[#f9e2f5] to-[#f3bae2] rounded-2xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between text-white shadow-xl mb-16 relative overflow-hidden">
          {/* Hat icon placeholder (using SVG) */}
          <div className="absolute top-0 left-12 -translate-y-1/2 w-16 h-16 bg-white/20 rotate-12 rounded-lg blur-xl"></div>
          
          <div className="space-y-3 z-10 text-center md:text-left mb-8 md:mb-0">
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight">Start learning now</h2>
            <p className="text-lg text-white font-medium">Only <span className="font-bold text-white">$99</span> for a <span className="font-bold text-white">93 hour</span> complete course</p>
